...
export default function About() {
  return (
    <>
      <div className="bg-[#202020] text-white py-20 md:py-28 relative overflow-hidden border-t-4 border-[#ae1d1e]">
        <div className="absolute inset-0 opacity-15">
          <img src="/images/hero-car.png" alt="Background" className="w-full h-full object-cover" />
        </div>
        <div className="container mx-auto px-6 md:px-8 relative z-10">
          <span className="text-[#ae1d1e] font-bold uppercase tracking-widest text-sm mb-4 block">MG Polisaj</span>
