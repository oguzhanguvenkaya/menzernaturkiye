        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-[#002b3d] mb-6 leading-tight">
                1888&apos;den Bu Yana
                <br />
                <span className="text-[#e3000f]">Polisajda Mükemmellik</span>
              </h2>
            ...
            <div className="space-y-4">
              <div className="bg-[#f8f9fa] border-l-4 border-[#e3000f] p-6">
                <p className="text-xs font-black uppercase tracking-widest text-[#002b3d] mb-1">
                  Kuruluş Yılı
                </p>
                <p className="text-5xl font-black text-[#e3000f]">1888</p>
              ...
              <div className="grid grid-cols-1 gap-3">
                {sectors.map((s) => (
                  <div
                    key={s.label}
                    className="bg-white border border-gray-200 p-4 flex items-center gap-4 hover:border-[#e3000f] transition-colors"
                  >
                    <div className="w-10 h-10 bg-[#002b3d] flex items-center justify-center shrink-0">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {values.map((value) => (
              ...
              >
                <div className="w-11 h-11 bg-[#002b3d] group-hover:bg-[#e3000f] flex items-center justify-center mb-4 transition-colors">
                  <value.icon className="w-5 h-5 text-white" />
                </div>
                <h3 className="text-base font-black uppercase tracking-widest text-[#002b3d] mb-2">
                  {value.title}
                </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
              <div className="lg:col-span-3">
                ...
                <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-[#002b3d] mb-6 leading-tight">
                  ...
                  <br />
                  <span className="text-[#e3000f]">MG Polisaj</span>
                </h2>
                <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
                  <p>
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="bg-[#002b3d] text-white p-7">
                  <p className="text-xs font-black uppercase tracking-widest text-gray-400 mb-2">
                    Merkez
                  </p>
                  <div className="flex items-center gap-2 mb-1">
                    <MapPin className="w-4 h-4 text-[#e3000f] shrink-0" />
                ...
                <div className="border border-gray-200 p-6">
                  ...
                  <p className="text-sm font-black text-[#002b3d] uppercase tracking-wider">
                    Menzerna GmbH
                  </p>
                  <p className="text-xs text-gray-500 mt-1">
                    Resmi Türkiye Distribütörü
                  </p>
                  <div className="w-12 h-0.5 bg-[#e3000f] mt-3" />
                </div>
              </div>
            </div>
          </div>
